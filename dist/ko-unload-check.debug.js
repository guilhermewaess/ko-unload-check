(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ko-unload-check", [], factory);
	else if(typeof exports === 'object')
		exports["ko-unload-check"] = factory();
	else
		root["ko-unload-check"] = factory();
...
var _class = function () {
  ...
  (0, _createClass3.default)(_class, [{
    key: 'startProperties',
    value: function startProperties() {
      this.subscriptions = [];
      this.shouldCheck = false;
    }
  }, {
    key: 'subscribeObservables',
    value: function subscribeObservables(properties) {
      properties.forEach(this.subscribeProperty.bind(this));
    }
  }, {
    key: 'subscribeProperty',
    value: function subscribeProperty(property) {
      var _this = this;

      var subscription = property.subscribe(function () {
        _this.shouldCheck = true;
      });
      this.subscriptions.push(subscription);
    }
  }, {
    key: 'subscribeOnUnload',
    value: function subscribeOnUnload() {
      var _this2 = this;

      window.onbeforeunload = function (e) {
        if (_this2.shouldCheck) {
          return '';
        }
      };
    }
